...
export const SERVICES: Service[] = [
  {
    ...
    faqs: [
      ...
      { q: "What worktop materials do you install?", a: "We fit the full range — laminate, solid wood, Corian, quartz, granite and marble. Through our trade accounts with Global Granite and specialist stone suppliers, we can access materials not available on the high street and pass on competitive rates to our clients." },
