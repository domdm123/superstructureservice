          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-4 space-y-4">
            {filteredProjects.map((project, index) => {
              ...
              return (
                ...
                >
                  <div className={`relative overflow-hidden rounded-xl bg-black ring-0 outline-none isolate ${
                    ...
                    <Image
                      ...
                      alt={project.title}
                      fill
                      className="object-cover transition-transform duration-700 scale-[1.01] group-hover:scale-110 transform-gpu will-change-transform"
                    ...
                    <div className="absolute inset-0 p-5 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      ...
                      <div className="flex items-center gap-2 text-white text-sm font-semibold">
                        <span className="flex items-center gap-1.5 bg-white/20 px-3 py-1.5 rounded-lg">
                          <Eye size={14} />
                          View Project
                        </span>
                      </div>
