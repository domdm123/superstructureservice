        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.05] mb-6 text-white">
              ...
              <span className="text-[#c9a84c]">Construction Needs</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              <div key={s.label}>
                <div className="text-3xl font-bold text-[#c9a84c]">{s.num}</div>
              ...
              <div className="flex flex-col gap-3 text-sm text-gray-400 mb-10">
                {[
                  ...
                  <div key={item} className="flex items-center gap-2">
                    <Star size={13} className="text-[#c9a84c] flex-shrink-0" />
                    {item}
                  </div>
                ))}
              </div>
